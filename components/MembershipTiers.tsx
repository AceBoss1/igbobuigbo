...
const TIERS = [
  ...
  // Group 2: Paid lifetime tiers
  {
    ...
    tiers: [
      { id:'professional', name:'Professional', label:'₦10,000', note:'One-Time · Lifetime', color:'var(--ibi-gold)', bg:'rgba(212,175,55,0.06)', border:'rgba(212,175,55,0.3)' },
      { id:'business',     name:'Business',     label:'₦15,000', note:'One-Time · Lifetime', color:'var(--ibi-gold)', bg:'rgba(212,175,55,0.06)', border:'rgba(212,175,55,0.3)' },
      { id:'diaspora',     name:'Diaspora',     label:'$20',      note:'One-Time · Lifetime', color:'#60a5fa',        bg:'rgba(96,165,250,0.06)',  border:'rgba(96,165,250,0.3)' },
    ],
    perks: PAID_PERKS,
    featured: true,
  ...
  // Group 3: Patron / Executive
  {
    group: 'Patron',
    tiers: [
      { id:'patron', name:'Patron', label:'₦50,000', note:'One-Time · Lifetime', color:'var(--ibi-red-light)', bg:'rgba(200,16,46,0.06)', border:'rgba(200,16,46,0.3)' },
    ],
    perks: PATRON_PERKS,
